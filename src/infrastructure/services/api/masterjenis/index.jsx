...
const MasterJenis = {
  ...
  getMasterJenisByID: async (id) => {
    const response = await get({ url: word.URL_GET_MASTER_JENIS_BY_ID + id });
  ...
  editMasterJenis: async (id, data) => {
    const response = await put(word.URL_UPDATE_MASTER_JENIS + id, data);
    return response;
  },
};
