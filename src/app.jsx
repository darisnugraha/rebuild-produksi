...
import { PageSettings } from "./infrastructure/config/page-settings.js";

import Header from "./views/components/header/header.jsx";
import Sidebar from "./views/components/sidebar/sidebar.jsx";
import SidebarRight from "./views/components/sidebar-right/sidebar-right.jsx";
import TopMenu from "./views/components/top-menu/top-menu.jsx";
import Content from "./views/components/content/content.jsx";
import Footer from "./views/components/footer/footer.jsx";
import FloatSubMenu from "./views/components/float-sub-menu/float-sub-menu.jsx";
...
class App extends React.Component {
  ...
  render() {
    const isAuthenticated = getLocal("isLogin");
    return (
      <>
        {isAuthenticated ? (
          <PageSettings.Provider value={this.state}>
            <div
              className={
                ...
                (this.state.pageRightSidebar
                  ? "page-with-right-sidebar "
                  : "") +
                (this.state.pageSidebarWide ? "page-with-wide-sidebar " : "") +
                (this.state.pageSidebarLight
                ...
                (this.state.pageContentFullHeight
