...
import laporankirimproduksi from "../../../../../application/selectors/laporanproduksi";

const TableLaporanKirimProduksi = () => {
  const columns = [
    {
      title: "No Kirim",
      dataIndex: "no_kirim",
  ...
  const dataLaporanKirimProduksi = useSelector(
    laporankirimproduksi.getAllKirimProduksi
  );

  return (
    <Table
      dataSource={dataLaporanKirimProduksi}
      columns={columns}
        ...
        <Table.Summary fixed>
          <Table.Summary.Row>
            ...
            <Table.Summary.Cell index={1} align="right">
              {dataLaporanKirimProduksi.reduce(
                (a, b) => a + parseFloat(b.stock_out),
                0
              )}
            </Table.Summary.Cell>
            <Table.Summary.Cell index={2} align="right">
              {dataLaporanKirimProduksi
...
export default TableLaporanKirimProduksi;
