...
import TerimaTambahanProduksi from "../../../../../application/selectors/laporanproduksi";
...
const BtnPrint = () => {
  ...
  const dataLaporanTerimaTambahanProduksi = useSelector(
    TerimaTambahanProduksi.getAllTerimaTambahanProduksi
  );
  ...
  const pdfExportHandle = () => {
    pdfReport(dataLaporanTerimaTambahanProduksi);
  };
  ...
  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport
          dataExel={dataLaporanTerimaTambahanProduksi}
          dataHead={datahead}
        />
      </Col>
