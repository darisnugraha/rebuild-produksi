    ...
    return (
      <>
        <ReactHTMLTableToExcel
          ...
          table="table-to-xls"
          filename={`LAPORAN TERIMA TAMBAHAN PRODUKSI (${this.props.dataHead?.nama_divisi})`}
          sheet={`LAPORAN TERIMA TAMBAHAN PRODUKSI (${this.props.dataHead?.nama_divisi})`}
          ...
          <thead>
            <tr>
              <td
                ...
                colSpan="5"
              >
                LAPORAN TERIMA TAMBAHAN PRODUKSI (
                {this.props.dataHead?.nama_divisi})
              </td>
            </tr>
            <tr>
              <td
