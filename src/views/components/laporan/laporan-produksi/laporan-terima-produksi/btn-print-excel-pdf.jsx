...
const BtnPrint = () => {
  ...
  const datahead = JSON.parse(localStorage.getItem("laporan_terima_produksi"));

  const pdfExportHandle = () => {
    pdfReport(dataLaporanTerimaProduksi);
  };

  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport dataExel={dataLaporanTerimaProduksi} dataHead={datahead} />
      </Col>
