...
const pdfReport = (data = "") => {
  ...
  let finalY = 30;
  doc.text(`Laporan Terima Gudang Produksi (${datahead.nama_divisi})`, 14, 15);
  doc.setFontSize(20);
  doc.text("PRODUKSI", 200, 15);

  doc.setFontSize(10);
  doc.setProperties({
    title: `Terima Gudang Produksi  (${datahead.nama_divisi})`,
  });
  ...
  x.document.write(
    `<html>
    <head>
    <title>Terima Gudang Produksi (${datahead.nama_divisi})</title>
    </head>
