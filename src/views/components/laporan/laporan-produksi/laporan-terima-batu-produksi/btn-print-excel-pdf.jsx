...
import TerimaBatu from "../../../../../application/selectors/laporanproduksi";
...
const BtnPrint = () => {
  ...
  const dataLaporanTerimaBatu = useSelector(
    TerimaBatu.getAllTerimaBatuProduksi
  );
  ...
  const pdfExportHandle = () => {
    pdfReport(dataLaporanTerimaBatu);
  };

  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport dataExel={dataLaporanTerimaBatu} dataHead={datahead} />
      </Col>
