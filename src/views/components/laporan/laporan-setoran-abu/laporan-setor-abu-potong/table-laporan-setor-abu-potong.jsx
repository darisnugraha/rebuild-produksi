...
import laporansetorabupotong from "../../../../../application/selectors/laporansetorabupotong";

const TableLaporanSetorAbuPotong = () => {
  const columns = [
    {
      title: "Tanggal",
      dataIndex: "tanggal",
  ...
  const dataLaporanSetorAbuPotong = useSelector(
    laporansetorabupotong.getAllLaporanSetorAbuPotong
  );

  return (
    <Table
      dataSource={dataLaporanSetorAbuPotong}
      columns={columns}
...
export default TableLaporanSetorAbuPotong;
