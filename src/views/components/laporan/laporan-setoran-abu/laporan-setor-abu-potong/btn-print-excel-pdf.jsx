...
const BtnPrint = () => {
  ...
  const datahead = JSON.parse(localStorage.getItem("laporan_setor_abu_potong"));

  const pdfExportHandle = () => {
    pdfReport(dataLaporanSetorAbuPotong);
  };

  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport dataExel={dataLaporanSetorAbuPotong} dataHead={datahead} />
      </Col>
