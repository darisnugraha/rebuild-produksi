    ...
    return (
      <>
        <ReactHTMLTableToExcel
          ...
          table="table-to-xls"
          filename="LAPORAN TERIMA MASAK"
          sheet="LAPORAN TERIMA MASAK"
              ...
              return (
                <>
                  <tr>
                    ...
                    <td style={{ textAlign: "right" }}>{element.berat_jadi}</td>
                    <td style={{ textAlign: "right" }}>
                      {element.berat_susut}
                    </td>
                  </tr>
