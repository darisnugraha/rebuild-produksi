...
const pdfReport = (data = "") => {
  ...
  let finalY = 30;
  doc.text("Laporan Tambah Saldo Bahan", 14, 15);
  doc.setFontSize(20);
  ...
  data.forEach((element) => {
    const kadarkali = parseFloat(element.kadar) / 100;
    let karat24 = parseFloat(element.berat) * kadarkali;
  ...
  x.document.write(
    `<html>
    <head>
    <title>Tambah Saldo Bahan</title>
    </head>
