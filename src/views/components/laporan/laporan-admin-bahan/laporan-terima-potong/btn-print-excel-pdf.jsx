...
const BtnPrint = () => {
  ...
  const dataTerimaPotong = useSelector(TerimaPotong.getAllLaporanTerimaPotong);
  const datahead = JSON.parse(localStorage.getItem("laporan_terima_potong"));

  const pdfExportHandle = () => {
    pdfReport(dataTerimaPotong);
  };

  return (
    <Row style={{ marginTop: 15 }}>
      <Col span={10} style={{ marginTop: 10 }}>
        <ExcelReport dataExel={dataTerimaPotong} dataHead={datahead} />
      </Col>
