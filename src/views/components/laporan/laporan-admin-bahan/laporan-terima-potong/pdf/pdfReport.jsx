...
const pdfReport = (data = "") => {
  ...
  const datahead = JSON.parse(localStorage.getItem("laporan_terima_potong"));
  let tableRows = [];
  let tableColumn = [];

  let finalY = 30;
  doc.text("Laporan Terima Potong", 14, 15);
  doc.setFontSize(20);
  ...
  tableColumn = [
    [
      ...
      {
        content: `BERAT PENTOLAN`,
      },
      {
        content: `BERAT BARANG`,
      },
      {
        content: `BERAT SUSUT`,
      },
  ...
  data.forEach((element) => {
    const row = [
      ...
      {
        content: element.berat_pentolan,
        styles: {
          halign: "right",
        },
      },
      {
        content: element.berat_barang,
        styles: {
          halign: "right",
        },
      },
