...
const TableAbuSetorTukangCor = () => {
  const dataAbuCastingOutstand = useSelector(Dashboard.getAllAbuCastingOutstand);
  return (
    <Table dataSource={dataAbuCastingOutstand} columns={columns} scroll={{ x: 500, y: 1500 }} />
  );
};
