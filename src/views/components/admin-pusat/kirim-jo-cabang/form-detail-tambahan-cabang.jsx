...
const maptostate = (state) => {
  ...
  if (state.kirimjocabang.dataEditTambahan !== undefined) {
    return {
      initialValues: {
        no_job_order: state.kirimjocabang.dataEditTambahan.no_job_order,
        nama_bahan: state.kirimjocabang.dataEditTambahan.nama_bahan_tambahan,
        jumlah_bahan: state.kirimjocabang.dataEditTambahan.jumlah_tambahan,
        berat_bahan: state.kirimjocabang.dataEditTambahan.berat_tambahan,
      },
    };
  } else {
    if (dataJO !== null) {
...
let FormDetailTambahanCabang = ({ visible, onCreate, onCancel }, prop) => {
...
FormDetailTambahanCabang = reduxForm({
  form: "FormDetailTambahanCabang",
  enableReinitialize: true,
})(FormDetailTambahanCabang);
export default connect(maptostate, null)(FormDetailTambahanCabang);
