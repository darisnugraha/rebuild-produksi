...
export const SET_DATA_SALDO_MURNI_SUCCESS = "[saldomurni] get all saldo murni success";
export const SET_DATA_SALDO_MURNI_FAILED = "[saldomurni] get all saldo murni failed";

export const SET_TAMBAH_SALDO_MURNI_ON = "[saldomurni] tambah saldo murni form on";
export const SET_TAMBAH_SALDO_MURNI_OFF = "[saldomurni] tambah saldo murni form off";

export const SET_AMBIL_SALDO_MURNI_ON = "[saldomurni] ambil saldo murni form on";
export const SET_AMBIL_SALDO_MURNI_OFF = "[saldomurni] ambil saldo murni form off";
